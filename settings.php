...
//blog title
$blog_config['title'] = 'Bankeys - news';
//blog sub title
$blog_config['intro'] = '新闻';
//blog author
$blog_config['author']='Bankeys';
//"About Me" box
$blog_config['aboutme']='This is about Bankeys';
//blog avatar
...
$blog_config['duoshuo_short_name'] = 'Bankeys';
//disqus short name
...
//
//
$blog_config['dropbox']['key']= 'mrd6n8e482cnlpc';
$blog_config['dropbox']['secret']= 'pha67zdmnu3x7do';
$blog_config['dropbox']['access_token']= 'eQxgPI3aH4AAAAAAAAAADxnHRjk6csqem2qWWRYdKpN2zTKygEWJ9t84LFcKHmnH';
